...
class Bull_Call_Spread_Record(Record):

    def __init__(self, market_info, _call_name, call_price, _l_call_name, _l_call_price, _volume, _days_to_mature_when_enter, _ua_entry_price ):
        super().__init__()
        self.call_name = _call_name
        self.market_info = market_info
        self.call_op = self.market_info.find_option_with_name(_call_name)
        self.call_entry_price = call_price
        self.l_call_name = _l_call_name
        self.l_call = self.market_info.find_option_with_name(_l_call_name)
        self.l_call_price = _l_call_price
        self.volume = _volume
        self.days_to_mature_when_enter = _days_to_mature_when_enter
        self.ua_entry_price = _ua_entry_price
        ...
        self.ua_asset = self.call_op.get_underlying_asset()
        self.strike_price = self.call_op.get_strike_price()
        self.expected_ROI = self.__calculate__ROI(self.l_call_price, self.call_entry_price, self.days_to_mature_when_enter)
        self.expected_untill_loss = self.__calculte_confidence_interval(self.ua_entry_price)
