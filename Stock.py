...
class Stock:
    def __init__(self, _ticker, _full_name, _close, _high, _low, _last, _volume, _best_kharid, _best_foroosh, _spread, _astaneh_bala, _astaneh_paein):
        self.ticker = _ticker
        ...
        self.spread = _spread
        self.astaneh_bala = _astaneh_bala
        self.astaneh_paein = _astaneh_paein
    ...
    def get_cost_to_sell(self, sarkhat_or_latest = 'sarkhat'):
        price = max ((self.best_kharid if sarkhat_or_latest == 'sarkhat' else self.last) , self.astaneh_paein)
        return price
